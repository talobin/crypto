...
public class SurBitcoin extends Market {
    ...
    private static final String NAME = "SurBitcoin";
    private static final String TTS_NAME = "Sur Bitcoin";
    private static final String URL = "https://api.blinktrade.com/api/v1/%2$s/ticker?crypto_currency=%1$s";

    static {
        CURRENCY_PAIRS = new LinkedHashMap();
        CURRENCY_PAIRS.put(VirtualCurrency.BTC, new String[]{Currency.VEF});
    }
