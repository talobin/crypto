...
public abstract class Market {
    ...
    public final Ticker parseTickerMain(int requestId, String responseString, Ticker ticker, CheckerInfo checkerInfo) throws
                                                                                                                      Exception {
    ...
    public final void parseCurrencyPairsMain(int requestId, String responseString, List<CurrencyPairInfo> pairs) throws
                                                                                                                 Exception {
    ...
    protected void parseCurrencyPairsFromJsonObject(int requestId, JSONObject jsonObject, List<CurrencyPairInfo> list) throws
                                                                                                                       Exception {
    }
}
